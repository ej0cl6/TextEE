...
raw_special_tokens_roberta = json.load(
    open(f"{os.path.dirname(__file__)}/additional-tokens_roberta.json", "r", encoding="utf-8")
)
special_tokens_roberta = [itm.lstrip("Ġ") for itm in raw_special_tokens_roberta]
