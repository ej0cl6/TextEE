...
TRAIN_DIR = "BioNLP-ST-2013_GE_train_data_rev3"
DEV_DIR = "BioNLP-ST-2013_GE_devel_data_rev3"
...
def read_docs(path):
    ...
    for file, file_dir in tqdm(file_list1+file_list2, ncols=100):
        ...
        for line in t_lines:
            ...
            if text[start:end] != entity_text:  # fix annotation errors
                if entity_text == "signal transducer and activator of transcription (STAT)1":
                    end -= 1
                elif entity_text == "betaI":
                    end -= 1
                elif entity_text == "MIP-1alpha":
                    start += 1
                elif entity_text == "IL-1beta":
                    start += 1
